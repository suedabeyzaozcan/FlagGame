...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(barButtonSystemItem: .action, target: self, action: #selector(showScore))  // Burada scoreLabel yerine showScore kullandık
    ...
    @objc func showScore() {  // Burada scoreLabel yerine showScore olarak yeniden adlandırdık
        let scoreText = "Your final score is \(score)."
        let vc = UIActivityViewController(activityItems: [scoreText], applicationActivities: nil)
